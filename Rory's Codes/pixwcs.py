...
#load science header
header = fits.getheader('/Volumes/64FLASH/astro/photometry/NGC6819/raw/raw+/ib2o01/ib2o01020_drc.fits', 'sci')
#get the wcs information from the header
w = WCS(header)
#load the pixel coordinates of sources
xpos, ypos = loadtxt('/Volumes/64FLASH/dolphotresults/ib2o01/positions.txt', unpack=True)
